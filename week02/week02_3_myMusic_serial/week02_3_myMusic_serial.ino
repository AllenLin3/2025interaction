...
//修改自week02_2_myMusic
// MakerUno 的 DefaultSketch 先複製過來
// 把 setup() 裡的 for迴圈 35-41 , Copy到 myMusic
...
{
  delay(1000);
  Serial.begin(9600);//第5行, Arduino裡 , setup()
...
void serialEvent(){//第6行， 負責USB 的 Serial 的函式
  while(Serial.available()){//第7行，如果USB 有資料
    Serial.read();//第8行,就讀進來
    myMusic();//順便 myMusic 播音樂
  }
}
void loop()
{
